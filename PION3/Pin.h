...
#define pin_OFF()		GPIO_ResetBits(GPIOC,GPIO_Pin_9) //GPIO_WriteBit(GPIOC,GPIO_Pin_12,(BitAction)0)
#define POWER_OFF() GPIO_ResetBits(GPIOC,GPIO_Pin_9)
#define LED_CHARGE_ON() GPIO_SetBits(GPIOC,GPIO_Pin_12)
#define LED_CHARGE_OFF() GPIO_ResetBits(GPIOC,GPIO_Pin_12)

#define pin_LED_CHARGE		GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_12)
//#define pin_KEY2		GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)


#define CHARGE_ON() GPIO_SetBits(GPIOC,GPIO_Pin_13)
#define CHARGE_OFF() GPIO_ResetBits(GPIOC,GPIO_Pin_13)
