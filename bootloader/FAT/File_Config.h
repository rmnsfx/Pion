...
//Þðà
extern BOOL fat_read_data(U32 adr, U8 *buf, U16 cnt); 
extern BOOL fat_write_data(U32 adr, U8 *buf, U16 cnt); 
...
extern BOOL mmc_format(void);
/*
#define  mmc_init(a)		   flash_init(a)
#define  mmc_write_sect(a,b,c) flash_write_sect(a,b,c)
#define  mmc_read_sect(a,b,c)  flash_read_sec(a,b,c)
#define  mmc_read_config(a)	   flash_read_config(a)
  */
